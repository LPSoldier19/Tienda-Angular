          ...
          <div className="col s6 form-container animated fadeIn slow">
            <form onSubmit={this.checkLogin}>
              ...
              <div className="col s12 input-field">
                <input type="email" ref="email" id="email" value={this.state.email} onChange={this.handleChange} placeholder="Ingrese el correo" className="validate white-text" required aria-required="true" />
              ...
              <div className="col s12 input-field">
                <input type="password" ref="password" id="password" value={this.state.password} onChange={this.handleChange} placeholder="Ingrese su contraseña" className="validate  white-text" required aria-required="true" />
